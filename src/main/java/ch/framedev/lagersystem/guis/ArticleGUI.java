...
import ch.framedev.lagersystem.dialogs.ArticleQrCodeDialog;
import ch.framedev.lagersystem.dialogs.ArticleQrPreviewDialog;
import ch.framedev.lagersystem.dialogs.ArticleStatsDialog;
import ch.framedev.lagersystem.main.Main;
import ch.framedev.lagersystem.managers.ArticleManager;
import ch.framedev.lagersystem.utils.ArticleBulkActions;
import ch.framedev.lagersystem.utils.ArticlePdfExporter;
import ch.framedev.lagersystem.utils.CategoryResolver;
...
import static ch.framedev.lagersystem.dialogs.ArticleDialog.showAddArticleDialog;
import static ch.framedev.lagersystem.dialogs.ArticleDialog.showUpdateArticleDialog;
import static ch.framedev.lagersystem.dialogs.DisplayWarningDialog.showAllWarnings;
...
public class ArticleGUI extends JFrame {
    ...
    private Set<String> categoryNames = Collections.emptySet();
    ...
    public ArticleGUI() {
        ...
        addArticleButton.addActionListener(e -> {
            Object[] row = showAddArticleDialog(this);
            if (row != null) {
        ...
        editArticleButton.addActionListener(e -> {
            ...
            Object[] updatedRow = showUpdateArticleDialog(this, existingData);
            if (updatedRow != null) {
        ...
        card.add(loadingPanel, BorderLayout.NORTH);
...
// base colors
        ...
        showWarningsBottomBtn.addActionListener(e -> showAllWarnings(this));
     ...
     * If no articles are selected, the user will be prompted to make a choice.
    ...
    private void initializeTable() {
        ...
        String tableFontSizeValue = SettingsGUI.Variable.TABLE_FONT_SIZE.getValue();
        int tableFontSize = SettingsGUI.TABLE_FONT_SIZE;
        if (tableFontSizeValue != null) {
            try {
                tableFontSize = Integer.parseInt(tableFontSizeValue);
            } catch (NumberFormatException ignored) {
            }
        }
        articleTable.setFont(SettingsGUI.getFontByName(Font.PLAIN, tableFontSize));
     ...
     * Uses landscape A4 format and dynamically scales content to fit.
     */
    ...
    private void loadArticles() {
        int seq = loadSequence.incrementAndGet();
        setLoading(true);
        SwingWorker<List<Article>, Void> worker = new SwingWorker<>() {
            ...
            protected void done() {
                ...
                try {
                    ...
                    setLoading(false);
                    JOptionPane.showMessageDialog(ArticleGUI.this,
    ...
    private void setUpdatingTable(boolean updating) {
        isUpdatingTable = updating;
    }
    ...
    private void handleInlineEdit(int modelRow) {
        ...
        updateArticleAsync(article, articleNumber, modelRow);
    }
    ...
    private void updateArticleAsync(Article article, String articleNumber, int modelRow) {
        SwingWorker<Boolean, Void> worker = new SwingWorker<>() {
            @Override
            protected Boolean doInBackground() {
                return ArticleManager.getInstance().updateArticle(article);
            }
    ...
    private JPanel createLoadingPanel() {
        ...
        JLabel loadingLabel = new JLabel("Lade Artikel...");
        loadingLabel.setFont(SettingsGUI.getFontByName(Font.PLAIN, 12));
        loadingLabel.setForeground(ThemeManager.getTextSecondaryColor());

        JProgressBar loadingBar = new JProgressBar();
        loadingBar.setIndeterminate(true);
        loadingBar.setBorderPainted(false);
        loadingBar.setPreferredSize(new Dimension(140, 8));
    ...
    private void deleteSelectedArticles() {
        ArticleBulkActions.deleteSelectedArticles(
                this,
                articleTable,
                this::updateCountLabel,
                this::setUpdatingTable,
                Main.iconSmall
        );
    }

    private void adjustStockForSelectedArticles() {
        ArticleBulkActions.adjustStockForSelectedArticles(
                this,
                articleTable,
                getSelectedArticles(),
                this::setUpdatingTable,
    ...
    private void exportSelectedArticles() {
        ArticleBulkActions.exportSelectedArticles(
                this,
                getSelectedArticles(),
                Main.iconSmall
        );
    ...
    private JPopupMenu createTablePopup() {
        ...
        editItem.addActionListener(e -> {
            ...
            Object[] existingData = ((DefaultTableModel) articleTable.getModel()).getDataVector().elementAt(modelRow).toArray();
            Object[] updated = showUpdateArticleDialog(this, existingData);
            if (updated != null) {
                DefaultTableModel model = (DefaultTableModel) articleTable.getModel();
    ...
    private void loadCategories() {
        categoryResolver = CategoryResolver.fromResource("/categories.json");
        categoryNames = new TreeSet<>(categoryResolver.getCategoryNames().keySet());
    }
    ...
    private String getCategoryForArticle(String articleNumber) {
        ...
        return categoryResolver.resolveCategory(articleNumber);
    }
