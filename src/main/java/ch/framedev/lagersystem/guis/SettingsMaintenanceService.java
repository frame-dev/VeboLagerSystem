...
final class SettingsMaintenanceService {
    ...
    static void openCategorySettingsFile(Logger logger) {
        ...
        try {
            ...
            SettingsDialogService.showError("Fehler", "Fehler beim Öffnen der Kategorien-Datei:\n" + e.getMessage());
    ...
    static DeleteOldLogsResult deleteOldLogs(Logger logger, boolean showDialog) {
        ...
        if (showDialog) {
            SettingsDialogService.showInfo("Alte Protokolle gelöscht", message);
        }
        logger.info(
                "{}{}",
                message,
    ...
    static void deleteAllLogs(Logger logger, Component parent) {
        ...
        int confirm = SettingsDialogService.showYesNo(
        ...
        try {
            ...
            SettingsDialogService.showError("Fehler", "Fehler beim Löschen der Protokolle:\n" + e.getMessage());
        ...
        if (logManager.clearAllLogs()) {
            ...
            SettingsDialogService.showInfo("Protokolle gelöscht", "Alle Protokolle wurden erfolgreich gelöscht.");
        } else {
            ...
            SettingsDialogService.showError(
                    "Fehler",
                    "Die Protokolldateien wurden gelöscht, aber die Datenbankprotokolle konnten nicht entfernt werden.");
        }
    }
    ...
    static void openLogsFolder(Logger logger) {
        ...
        try {
            ...
            SettingsDialogService.showError("Fehler", "Fehler beim Öffnen des Protokolle-Ordners:\n" + e.getMessage());
    ...
    static void deleteTable(Component parent, Logger logger, String tableName) {
        ...
        try {
            ...
            if (dbManager != null) {
                ...
                SettingsDialogService.showError("Fehler", "Fehler: Datenbankverbindung nicht verfügbar.");
            }
        } catch (Exception e) {
    ...
    static void clearDatabase(Component parent, Logger logger) {
        int firstConfirm = SettingsDialogService.showYesNo(
        ...
        String confirmText = SettingsDialogService.showTextInput(
        ...
        if (confirmText == null || !confirmText.trim().equalsIgnoreCase("LÖSCHEN")) {
            SettingsDialogService.showInfo("Abgebrochen", "Vorgang abgebrochen. Die Datenbank wurde nicht gelöscht.");
            return;
        }
    ...
    private static int showRestartRecommendation() {
        return SettingsDialogService.showYesNo(
                "Neustart empfohlen",
    ...
    private static void deleteRuntimeDataFile(String fileName) {
        File file = new File(Main.getAppDataDir(), fileName);
        if (!file.delete()) {
            System.out.printf("[SettingsGUI] %s konnte nicht gelöscht werden (Datei existiert möglicherweise nicht)%n",
                    fileName);
        }
    }
}
