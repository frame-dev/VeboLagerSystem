...
/**
 * Cross-platform Unicode symbols for consistent display on Windows, macOS, and Linux.
 * Uses Unicode escape sequences instead of emoji to ensure compatibility.
 *
 * Organized by category for easier reference and maintenance.
 */
...
public class UnicodeSymbols {
    ...
    // ===================== Table/Column Helper =====================
    // Example: Use these for table column names
    ...
    public static final String COL_HINZUGEFUEGT = ADDED + " Hinzugefügt";
