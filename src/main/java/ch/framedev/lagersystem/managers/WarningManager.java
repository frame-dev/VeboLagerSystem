...
public class WarningManager {
    ...
    // Singleton Instance
    private static volatile WarningManager instance;
    // Database Manager
    ...
    public List<Warning> getAllWarnings() {
        ...
        return allWarningsCache != null ? allWarningsCache : Collections.unmodifiableList(warnings);
    }
